...
class ViewHolderDailyOffer extends RecyclerView.ViewHolder{
    private final ImageView dishPhoto;
    private final TextView dishName;
    private final TextView dishDesc;
...
public class DailyOffer extends Fragment {
    ...
    private final FirebaseRecyclerOptions<DishItem> options =
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.dish_list);
    ...
    public void deleteDish(String dishName){
        AlertDialog reservationDialog = new AlertDialog.Builder(Objects.requireNonNull(this.getContext())).create();
